...
- **Current package: R6.5-WP19H3 - Sunbeam Village Final Polish.** H3.1-H3.11.3 are human-approved. H3.11 is a dedicated walkable-interiors programme with H3.11.1-H3.11.10 and per-slice human review. The current bounded insertion is **H3.11-R1 - Bakery/Picnic progression and village-NPC remediation**. After R1 is approved, resume the active **H3.11.4 Story House A-F library/reader programme**. Once Story House is complete, run **H3.11-R2 - Wobbly Cake baking mini-game** before continuing to the already-assigned H3.11.5-H3.11.10 interiors/content slices. These R1/R2 inserts deliberately do not renumber H3.11.5-H3.11.10. H3.12 remains planned for wider cross-region recurring-character presence coherence. David's next play pass may amend those slices or add H3.13+. Final hardening/consolidation remains unnumbered until substantive Sunbeam review is explicitly complete.
...
State: **feedback block 1 complete / H3.1-H3.11.3 human-approved / H3.11-R1 remediation current / H3.11.4 Story House resumes next / H3.11-R2 Wobbly Cake mini-game follows Story House / H3.12 wider presence-coherence pass planned / human play pass ongoing**.
...
11. **H3.11 - Village interiors and local content maturity:** umbrella programme. Rebuild Sunbeam interiors as proper playable world spaces using the same broad physicality philosophy as Moonflower Cottage: the player enters as their unicorn, moves around, collides with walls/furniture/counters, layers correctly around props, approaches NPCs/interactables through the shared interaction system and exits through a physical door. The same NPC must not independently exist outside and inside at once. Role-specific presentation is encouraged, and the Bakery baker must have an unmistakable baker/chef identity including a proper hat and workwear.
    ...
    - **H3.11-R1 - Bakery/Picnic progression and village-NPC remediation:** **current bounded remediation pass.** Gate Marigold's picnic progression so it cannot relocate/lock Maple before the Wobbly Cake quest is complete; move Marigold into a clear plaza position; keep Maple's Bakery route clear of the Glade sign; and clean up the current Wobbly Cake interface overlap. Do **not** expand this pass into the full baking mini-game.
    - **H3.11.4 - Story House rebuild and long-form library system:** resume immediately after R1. Continue the active A-F library/reader programme, with H3.11.4F remaining the current Story House completion track.
