...
export const CONCEPT_UI = {
  ...
  blue: cssColourToPhaser(UI_DESIGN_TOKENS.colour.conceptBlue),
  blueLight: cssColourToPhaser(UI_DESIGN_TOKENS.colour.conceptBlueLight),
  blueStrong: cssColourToPhaser(UI_DESIGN_TOKENS.colour.conceptBlueStrong),
  blueDeep: cssColourToPhaser(UI_DESIGN_TOKENS.colour.conceptBlueDeep),
