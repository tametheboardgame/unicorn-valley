...
const SCENE_AUDIO: Record<AudioSceneProfile, SceneAudioDefinition> = {
  menu: {
    musicNotes: [
      523.25, 659.25, 783.99, 659.25, 587.33, 698.46, 783.99, 880, 783.99, 698.46, 659.25, 587.33,
  ...
  glade: {
    musicNotes: [
      523.25, 659.25, 783.99, 659.25, 587.33, 659.25, 523.25, 392, 440, 523.25, 659.25, 783.99, 880,
      783.99, 698.46, 659.25, 587.33, 523.25, 493.88, 523.25, 587.33, 659.25, 523.25, 392,
    ],
    musicIntervalMs: 760,
    musicWave: 'triangle',
  ...
  village: {
    musicNotes: [
      392, 493.88, 587.33, 523.25, 493.88, 440, 523.25, 659.25, 587.33, 659.25, 783.99, 659.25,
      587.33, 523.25, 493.88, 440, 493.88, 587.33, 659.25, 783.99, 698.46, 659.25, 523.25, 392,
    ],
    musicIntervalMs: 620,
    musicWave: 'triangle',
  ...
  meadow: {
    musicNotes: [
      392, 523.25, 659.25, 783.99, 659.25, 783.99, 880, 1046.5, 880, 783.99, 698.46, 659.25, 587.33,
      659.25, 783.99, 880, 987.77, 880, 783.99, 659.25, 587.33, 523.25, 493.88, 392,
    ],
    musicIntervalMs: 680,
    musicWave: 'triangle',
  ...
  brook: {
    musicNotes: [
      349.23, 440, 523.25, 659.25, 587.33, 523.25, 440, 392, 440, 523.25, 587.33, 698.46, 783.99,
      698.46, 587.33, 523.25, 493.88, 523.25, 659.25, 783.99, 698.46, 587.33, 440, 349.23,
    ],
    musicIntervalMs: 820,
    musicWave: 'sine',
  ...
  cottage: {
    musicNotes: [
      349.23, 440, 523.25, 440, 392, 440, 349.23, 293.66, 349.23, 392, 440, 523.25, 587.33, 523.25,
      440, 392, 349.23, 440, 392, 349.23,
    ],
    musicIntervalMs: 840,
    musicWave: 'sine',
  ...
  race: {
    musicNotes: [
      523.25, 659.25, 783.99, 1046.5, 880, 783.99, 659.25, 783.99, 587.33, 698.46, 880, 1174.66,
      987.77, 880, 783.99, 698.46, 659.25, 783.99, 987.77, 1318.51, 1174.66, 987.77, 880, 783.99,
      698.46, 783.99, 880, 1046.5, 987.77, 880, 659.25, 523.25,
    ],
    musicIntervalMs: 340,
    musicWave: 'triangle',
