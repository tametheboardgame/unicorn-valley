...
// H1.10 reserves the north-west stream bank beside the cottage for a future growing plot. Keep the
// other three organic reed beds so the stream retains natural bank vegetation away from the garden.
