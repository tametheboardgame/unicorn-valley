...
export const SUNBEAM_VILLAGE_LAYOUT = {
  ...
  boundaryFence: {
    ...
    segments: [
      ...
      { id: 'south', orientation: 'horizontal', x: 1500, y: 1785, length: 2760 },
      { id: 'west-north', orientation: 'vertical', x: 120, y: 435, length: 640 },
      { id: 'west-south', orientation: 'vertical', x: 120, y: 1450, length: 670 },
      { id: 'east-north', orientation: 'vertical', x: 2880, y: 435, length: 640 },
      { id: 'east-south', orientation: 'vertical', x: 2880, y: 1450, length: 670 },
    ],
    posts: [
      { id: 'north-west', x: 120, y: 115 },
      { id: 'north-east', x: 2880, y: 115 },
      { id: 'south-west', x: 120, y: 1785 },
      { id: 'south-east', x: 2880, y: 1785 },
