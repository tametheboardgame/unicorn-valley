...
import {
  R65_CROSS_REGION_FOLLOW_UP_DISCOVERIES,
  R65_CROSS_REGION_FOLLOW_UP_ITEMS,
  R65_CROSS_REGION_FOLLOW_UP_QUESTS,
} from './r65CrossRegionFollowUp';
import { R65_RACE_EXPANSION_DISCOVERIES, R65_RACE_EXPANSION_ITEMS } from './r65RaceExpansion';
import { R65_REPEATABLE_ACTIVITY_DISCOVERIES } from './r65RepeatableActivities';
import {
  R65_STARLIGHT_BEACH_CHARACTERS,
  R65_STARLIGHT_BEACH_DISCOVERIES,
  R65_STARLIGHT_BEACH_ITEMS,
  R65_STARLIGHT_BEACH_QUESTS,
} from './r65StarlightBeach';
import {
...
import {
  R6_EXISTING_VALLEY_QUEST_CHARACTERS,
  R6_EXISTING_VALLEY_QUEST_DISCOVERIES,
  R6_EXISTING_VALLEY_QUEST_ITEMS,
  R6_EXISTING_VALLEY_QUESTS,
} from './r6ExistingValleyQuestPack';
import {
...
const ALL_DISCOVERIES = [
  ...
  ...R6_EXISTING_VALLEY_QUEST_DISCOVERIES,
  ...R65_STARLIGHT_BEACH_DISCOVERIES,
  ...R65_RACE_EXPANSION_DISCOVERIES,
  ...R65_CROSS_REGION_FOLLOW_UP_DISCOVERIES,
  ...R65_REPEATABLE_ACTIVITY_DISCOVERIES,
