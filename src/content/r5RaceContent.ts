...
export const CRYSTAL_CASCADE_RIBBONS_DISCOVERY_ID =
  'discovery:crystal-cascade-ribbons' as const;

export const R5_RACE_ITEMS = [
  {
    id: CRYSTAL_CASCADE_FINISHER_RIBBON_ITEM_ID,
    name: 'Crystal Cascade Finisher Ribbon',
    description: 'A watery-blue ribbon for finishing Crystal Cascade. It can decorate your cottage.',
    category: 'decoration',
    icon: '🎀',
